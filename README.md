...
**Демо:** _[укажите ссылку GitHub Pages, например `https://username.github.io/repo/`]_  
...
Репертуар коллектива обычно ведётся в разрозненных списках: Word, Excel, бумажные тетради, переписки в мессенджерах. Из-за этого:
...
- с телефона на репетиции или выезде искать неудобно;
...
> Положите изображения в папку `docs/screenshots/` и раскомментируйте строки ниже.
...
_Укажите здесь своё имя, если нужно:_  
**Автор:** _[ФИО]_ · _[контакт / портфолио]_
